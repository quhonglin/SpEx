...
class Dataset(data.Dataset):
    def __init__(self, dataset_list, limit=None, offset=0, n_samples=32000, sr=8000, reference_length=5):
        """
        验证数据集
        ...
        # rstrip(): 去除结尾字符； expanduser(): 将路径中的"~/"展开，否则python无法识别
        # dataset_list: [[mix_1 target_1 refer_1], [2 2 2], ...]
        ...
        # extract target wav
        # target_wav_path_list: [target_1, target_2, ...]
